const arrow_down = `<svg fill="#FFFFFF" width="44px" height="44px" viewBox="0 0 22 22" id="memory-arrow-down">
...
const arrow_up = `<svg fill="#FFFFFF" width="44px" height="44px" viewBox="0 0 22 22" id="memory-arrow-up">
...
const trophy = `<svg fill="#FFFF00" height="34px" width="34px" id="Capa_1" viewBox="0 0 490.2 490.2" xml:space="preserve" stroke="#FFFF00">
