...
export const stacks = [
  {
    ...
    path: 'Stack > Installed  > DesarrolloWeb > Html5',
    id: 'html5',
  },
  {
    title: 'CSS',
    ...
    certificado: certificadoPath.DESARROLO_WEB,
    linkCertificado: certificadoPath.DESARROLO_WEB_LINK,
    path: 'Stack > Installed  > DesarrolloWeb > CSS',
    id: 'css',
  },
  {
    title: 'SASS',
    ...
    certificado: certificadoPath.DESARROLO_WEB,
    linkCertificado: certificadoPath.DESARROLO_WEB_LINK,
    path: 'Stack > Installed  > DesarrolloWeb > CSS > Sass',
    id: 'sass',
  },
  {
    title: 'BOOTSTRAP',
    ...
    certificado: certificadoPath.DESARROLO_WEB,
    linkCertificado: certificadoPath.DESARROLO_WEB_LINK,
    path: 'Stack > Installed  > DesarrolloWeb > Library > Bootstrap',
    id: 'bootstrap',
  },
  {
    title: 'JAVASCRIPT',
    ...
    path: 'Stack > Installed  > DesarrolloWeb > JavaScript',
    id: 'javaScript',
  },
  {
    title: 'REACT JS',
    ...
    path: 'Stack > Installed  > DesarrolloWeb > ReactJs',
    id: 'reactJs',
  },
  {
    title: 'FIREBASE',
    ...
    certificado: certificadoPath.REACTJS,
    linkCertificado: certificadoPath.REACTJS_LINK,
    path: 'Stack > Installed  > DesarrolloWeb > FireBase',
    id: 'firebase',
  },
  {
    title: 'NODE JS',
    ...
    path: 'Stack > Installed  > DesarrolloWeb > BackEnd > NodeJs',
    id: 'nodeJs',
  },
  {
    title: 'EXPRES JS',
    ...
    certificado: certificadoPath.BACKEND,
    linkCertificado: certificadoPath.BACKEND_LINK,
    path: 'Stack > Installed  > DesarrolloWeb > BackEnd > Framework > ExpressJs',
    id: 'expressJs',
  },
  {
    title: 'MONGO DB',
    ...
    certificado: certificadoPath.BACKEND,
    linkCertificado: certificadoPath.BACKEND_LINK,
    path: 'Stack > Installed  > DesarrolloWeb > BackEnd > DataBase > MongoDb',
    id: 'mongoDb',
  },
  {
    title: 'POSTMAN',
    ...
    certificado: certificadoPath.BACKEND,
    linkCertificado: certificadoPath.BACKEND_LINK,
    path: 'Stack > Installed  > DesarrolloWeb > BackEnd > Postman',
    id: 'postman',
  },
  {
    title: 'WORDPRESS',
    image: iconPath.WORDPRESS,
    shortDescription:
      'Es una plataforma de código abierto para la creación y gestión de sitios web, que ofrece una amplia variedad de temas y complementos para personalizar y ampliar las funcionalidades de un sitio web de manera fácil y accesible.',
    certificado: certificadoPath.WORDPRESS,
    linkCertificado: certificadoPath.WORDPRESS_LINK,
    path: 'Stack > Installed  > DesarrolloWeb > Wordpress',
    id: 'wordpress',
  },
];
